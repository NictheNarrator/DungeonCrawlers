...
export const NPCS = {
 ...
 rat:{name:'Ratman custodian',role:'Unpaid sanitation',hp:12,damage:[2,3],attitude:'neutral',stock:{gold:2},equipped:[],refuse:['gold'],onHit:'poisoned',home:3,routine:'guard',route:[3],abilities:{strength:8,dexterity:14,constitution:10,intelligence:8,wisdom:12,charisma:6},skills:['stealth','perception'],saves:['dexterity']}
};
