...
export const NPCS = {
 mara:{name:'Mara',role:'Cautious survivor',hp:20,damage:[4,6],attitude:'neutral',trade:'potions',price:3,pick:'key',help:'1 bandage or potion',stock:{gold:3,potions:2,key:1},equipped:['bandages'],refuse:['key'],onHit:'bleeding',home:2,routine:'shelter',route:[2],abilities:{strength:14,dexterity:12,constitution:14,intelligence:12,wisdom:15,charisma:13},skills:['medicine','insight'],saves:['wisdom','constitution']},
 tobin:{name:'Tobin',role:'Suspicious scavenger',hp:16,damage:[2,4],attitude:'suspicious',trade:'smokeBombs',price:4,pick:'smokeBombs',help:'1 repair kit or 2 coins',stock:{gold:6,potions:2,smokeBombs:2},equipped:['repairKits'],refuse:[],onHit:'bleeding',home:1,routine:'scavenge',route:[1,3],abilities:{strength:11,dexterity:15,constitution:12,intelligence:14,wisdom:13,charisma:12},skills:['sleight of hand','stealth','investigation'],saves:['dexterity','intelligence']},
 vex:{name:'Vex',role:'Dangerous rival',hp:28,damage:[5,7],attitude:'neutral',trade:'whetstones',price:4,pick:'whetstones',help:'Read the memo, or give 1 potion',stock:{gold:5,potions:1,whetstones:1},equipped:[],refuse:['potions'],onHit:'bleeding',home:4,routine:'patrol',route:[4,3],abilities:{strength:17,dexterity:16,constitution:15,intelligence:11,wisdom:12,charisma:14},skills:['athletics','intimidation','perception'],saves:['strength','constitution']},
 rat:{name:'Ratman scrapper',archetype:'scrapper',pack:'ratmen',role:'Unpaid sanitation',hp:12,damage:[2,3],attitude:'neutral',stock:{gold:2},equipped:[],refuse:['gold'],onHit:'poisoned',home:3,routine:'guard',route:[3],abilities:{strength:8,dexterity:14,constitution:10,intelligence:8,wisdom:12,charisma:6},skills:['stealth','perception'],saves:['dexterity']}
 ,skulker:{name:'Ratman skulker',archetype:'skulker',pack:'ratmen',role:'Thrown-object specialist',hp:10,damage:[1,2],thrown:[2,4],attitude:'neutral',stock:{gold:3,smokeBombs:1},equipped:[],refuse:['smokeBombs'],onHit:'bleeding',home:1,routine:'guard',route:[1],abilities:{strength:8,dexterity:16,constitution:10,intelligence:11,wisdom:13,charisma:7},skills:['stealth','perception'],saves:['dexterity']}
 ,brute:{name:'Ratman brute',archetype:'brute',pack:'ratmen',role:'Slow and heavy',hp:24,damage:[5,7],attitude:'neutral',stock:{gold:4,potions:1},equipped:[],refuse:['potions'],onHit:'bleeding',home:2,routine:'guard',route:[2],abilities:{strength:17,dexterity:9,constitution:16,intelligence:6,wisdom:9,charisma:5},skills:['athletics','intimidation'],saves:['strength','constitution']}
};
